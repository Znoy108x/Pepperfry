...
import Chairs_Img from "../../assets/ProductBanners/Chairs.jpg"
  ...
  return (
    <div className="w-full flex flex-col">
      ...
      <div className="px-20 w-full mt-7 flex flex-col">
        <img src={Chairs_Img} alt="" className="w-full h-[300px] object-cover" />
        <h1 className="text-center text-8xl font-dancing my-10       text-gray-900">Chairs</h1>
