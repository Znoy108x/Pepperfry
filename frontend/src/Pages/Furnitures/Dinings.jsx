...
import Dinings_Img from "../../assets/ProductBanners/dinings.jpg"
...
const Dinings = () => {
  ...
  useEffect(() =>{
    ...
    console.log(location.state.category._id)
  },[])
  ...
  return (
    <div className="w-full flex flex-col">
      ...
      <div className="px-20 w-full mt-7 flex flex-col">
        <img src={Dinings_Img} alt="" className="w-full h-[300px] object-cover" />
        <h1 className="text-center text-8xl font-dancing my-10       text-gray-900">Dinings</h1>
