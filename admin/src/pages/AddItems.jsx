...
const AddItems = () => {
  ...
  const HANDLE_ADD_ITEM = (e) => {
    ...
    axios.post("http://localhost:5000/api/create-items", ITEM_FORM , {withCredentials : true}).then((res) => {
    ...
    <div className="w-screen h-screen flex font-Baby_Urbanist relative ">
      ...
      <div className="h-full w-[85%] flex flex-col ">
        <div className="w-full h-full flex items-center justify-center ">
          <form onSubmit={HANDLE_ADD_ITEM} className="px-10 h-[96%] w-[80%]  bg-white shadow-2xl rounded-xl flex flex-col p-4 space-y-3 ">
            <span className=" font-semibold text-center text-3xl">Create a <span className='text-baby_purple'>Item</span> ...</span>
            ...
            <button className="w-1/3 mx-auto bg-baby_purple hover:bg-baby_sky text-white duration-300 rounded-3xl py-2 ripple-bg-baby_sky" type="submit">Add Item</button>
          </form>
